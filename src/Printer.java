...
//        System.out.println(String.format("%10.10s | %3.3s | %-10.10s | %-10.10s | %-10.9s |%-12.10s |", cat.getNewName(), cat.getNewAge(), cat.getHealth(), cat.getMood(), cat.getSatiety(), cat.getMiddleLevel()));
    }
